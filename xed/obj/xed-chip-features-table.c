...
void xed_init_chip_model_info(void)
{
   ...
   xed_chip_features[XED_CHIP_TGL][0] = 0
      |(one<<XED_ISA_SET_ADOX_ADCX)
      |(one<<XED_ISA_SET_AES)
      |(one<<XED_ISA_SET_AVX)
      |(one<<XED_ISA_SET_AVX2)
      ...
      |(one<<XED_ISA_SET_AVX512_VNNI_256)
      |(one<<XED_ISA_SET_AVX512_VNNI_512)
      |(one<<XED_ISA_SET_AVX512_VP2INTERSECT_128)
      |(one<<XED_ISA_SET_AVX512_VP2INTERSECT_256)
      |(one<<XED_ISA_SET_AVX512_VP2INTERSECT_512)
      |(one<<XED_ISA_SET_AVX512_VPCLMULQDQ_128)
      |(one<<XED_ISA_SET_AVX512_VPCLMULQDQ_256)
      |(one<<XED_ISA_SET_AVX512_VPCLMULQDQ_512);
   xed_chip_features[XED_CHIP_TGL][1] = 0
      |(one<<(XED_ISA_SET_AVX512_VPOPCNTDQ_128-64))
      |(one<<(XED_ISA_SET_AVX512_VPOPCNTDQ_256-64))
      |(one<<(XED_ISA_SET_AVX512_VPOPCNTDQ_512-64))
      |(one<<(XED_ISA_SET_AVXAES-64))
      ...
      |(one<<(XED_ISA_SET_SGX-64))
      |(one<<(XED_ISA_SET_SGX_ENCLV-64));
   xed_chip_features[XED_CHIP_TGL][2] = 0
      |(one<<(XED_ISA_SET_SHA-128))
      |(one<<(XED_ISA_SET_SMAP-128))
      |(one<<(XED_ISA_SET_SMX-128))
      |(one<<(XED_ISA_SET_SSE-128))
      ...
      |(one<<(XED_ISA_SET_XSAVEOPT-128))
      |(one<<(XED_ISA_SET_XSAVES-128));
   xed_chip_features[XED_CHIP_TGL][3] = 0;
   xed_chip_features[XED_CHIP_SPR][0] = 0
      |(one<<XED_ISA_SET_ADOX_ADCX)
      |(one<<XED_ISA_SET_AES)
      |(one<<XED_ISA_SET_AVX)
      |(one<<XED_ISA_SET_AVX2)
      ...
      |(one<<XED_ISA_SET_AVX512_VPCLMULQDQ_256)
      |(one<<XED_ISA_SET_AVX512_VPCLMULQDQ_512);
   xed_chip_features[XED_CHIP_SPR][1] = 0
      |(one<<(XED_ISA_SET_AVX512_VPOPCNTDQ_128-64))
      |(one<<(XED_ISA_SET_AVX512_VPOPCNTDQ_256-64))
      |(one<<(XED_ISA_SET_AVX512_VPOPCNTDQ_512-64))
      |(one<<(XED_ISA_SET_AVXAES-64))
      ...
      |(one<<(XED_ISA_SET_RDWRFSGS-64))
      |(one<<(XED_ISA_SET_RTM-64))
      |(one<<(XED_ISA_SET_SERIALIZE-64))
      |(one<<(XED_ISA_SET_SGX-64))
      |(one<<(XED_ISA_SET_SGX_ENCLV-64));
   xed_chip_features[XED_CHIP_SPR][2] = 0
      |(one<<(XED_ISA_SET_SHA-128))
      |(one<<(XED_ISA_SET_SMAP-128))
      |(one<<(XED_ISA_SET_SMX-128))
      |(one<<(XED_ISA_SET_SSE-128))
      ...
      |(one<<(XED_ISA_SET_XSAVEOPT-128))
      |(one<<(XED_ISA_SET_XSAVES-128));
   xed_chip_features[XED_CHIP_SPR][3] = 0;
